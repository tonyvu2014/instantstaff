...
const VerticalFeatures = () => (
  ...
  >
      ...
      details={
        <Fragment>
          <p className="py-2">
            ...
            By using our platform, child care and aged care centers can access a
            larger pool pool of qualified and vetted workers who are available
            for casual or part-time work. We&apos;ll do all the screening for
            you to save your time and resources needed for recruitment.
          </p>
          <p className="py-2">
    ...
    />
    <VerticalFeatureRow
      title="Unlocking Opportunities for Casual Workers: The Benefits of Joining Our Child and Aged Care Staffing Network"
      ...
      details={
        <Fragment>
          ...
          <p className="py-2">
            ...
            provides access to a wide range of child care and aged care centers,
            allowing workers to gain experience in different environments.
          </p>
          <p className="py-2">
          ...
          <p className="py-2">
            ...
            experience in different aspects of child and aged care through
